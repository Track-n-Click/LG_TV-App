document.addEventListener("DOMContentLoaded", () => {
  ...
  function navigate(step) {
    if (videoPlayers.length > 0) {
      ...
      currentIndex =
        (currentIndex + step + videoPlayers.length) % videoPlayers.length;
      videoPlayers[currentIndex].classList.add("video-active");
  ...
  function navigateRow(step) {
    ...
    if (videoPlayers.length > 0 && cols > 0) {
      ...
      if (newIndex >= 0 && newIndex < videoPlayers.length) {
        ...
        currentIndex =
          step > 0
            ? Math.min(videoPlayers.length - 1, currentIndex + cols)
  ...
  function togglePlayPause() {
    ...
    if (selectedPlayer) {
      if (document.fullscreenElement) {
        ...
        } else if (selectedPlayer.mozRequestFullScreen) {
          /* Firefox */
          selectedPlayer.mozRequestFullScreen();
        } else if (selectedPlayer.webkitRequestFullscreen) {
          /* Chrome, Safari and Opera */
          selectedPlayer.webkitRequestFullscreen();
        } else if (selectedPlayer.msRequestFullscreen) {
          /* IE/Edge */
...
const videoData = {
  "row0": [
    { "id": "vpleft", "title": "AYOZAT TV", "manifest": "https://cdn.rtmp1.vodhosting.com/hls/AyozatTV.m3u8", "type": "hls" },
    { "id": "vpright", "title": "AYOSPORT", "manifest": "https://cdn.rtmp1.vodhosting.com/hls/AYOSPORT.m3u8 ", "type": "hls" }
  ],
  "row1": [
    { "id": "vp00", "title": "AYO MUSIC", "manifest": "https://cdn.rtmp1.vodhosting.com/hls/AYO.m3u8 ", "type": "hls" },
    { "id": "vp01", "title": "RMT TV", "manifest": "https://cdn.rtmp1.vodhosting.com/hls/RMTTV.m3u8", "type": "hls" },
    { "id": "vp02", "title": "AYOZAT FIGHT NETWORK", "manifest": "https://cdn.rtmp1.vodhosting.com/hls/AFN.m3u8", "type": "hls" },
    { "id": "vp03", "title": "SERENDIB TV", "manifest": "https://cdn.rtmp1.vodhosting.com/hls/SerendibTV.m3u8", "type": "hls" }
  ],
  "row2": [
    ...
    { "id": "vp12", "title": "MILITARY TV", "manifest": "https://cdn.rtmp1.vodhosting.com/hls/MilitaryChannel.m3u8", "type": "hls" },
    { "id": "vp13", "title": "Ultimate Strength Network", "manifest": "https://cdn.rtmp1.vodhosting.com/hls/Strongman.m3u8", "type": "hls" }
  ]
};
